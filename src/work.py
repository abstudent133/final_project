...
customers = {
    "Susan McCombs" : {
        ...
        "responses" : ["Earth one or two ma'am?", "Earth was recently demolished to make room for a new hyperspace bypass.", "Why? Gonna go 'Earth it up?' with some Earth chump? You chump.", "Honestly I don't even know dude... go left I guess?"],
    ...
    "Joshua Jermithan" : {
        ...
        "happy_response" : "what a good lad you are."
    },
    ...
    "Freddie Skips" : {
        ...
        "happy_response" : "Ayyyyy, thanks for the tip kid."
    },
    ...
    "Tania the Destroyer" : {
        ...
        "happy_response" : ".... I've never heard a better idea!"
    },
    ...
    "Mr. Egg Senior" : {
        ...
        "happy_response" : "Ho ho! Good to see the youth is still enjoying the arts!"
    },
    ...
    "Riswalda Hicks" : {
        ...
        "responses" : ["Did you just quote 'a Christmas Carol'?", "Do you need something ma'am?", "Woahhh... That's so real.", "I don't need a fortune teller to tell me things I already know."],
        "correct" : "Woahhh... That's so real.",
        "incorrect" : ["Did you just quote 'a Christmas Carol'?"],
        "response" : "What? NO! What uhh, what even is, what did you say? 'A Fishnest... Barrel'?",
        "happy_response" : "Yesss, and only for $79.99 a month you can take my master class on divination."
    },
    ...
    "Ol' Moldy Bones" : {
        ...
        "happy_response" : "Ahh yes, I remember the invention of vinyl..."
    },
    ...
    "Easton Gifford" : {
        ...
        "incorrect" : ["Get out with your crazy ideas, why would anyone ever blast the baja?", "I'm not participating in your Mountain Dew scamming, get out."],
